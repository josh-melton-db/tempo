...
class IntervalsDF:
    ...
    def fromNestedBoundariesDF(cls,
        ...
        unpacked_boundaries_df = ( df.withColumn(start_element_name, Fn.col(start_path))
                                     .withColumn(end_element_name, Fn.col(end_path))
                                     .drop(nested_boundaries_col) )
        # return the results as an IntervalsDF
        return IntervalsDF(unpacked_boundaries_df, start_element_name, end_element_name, series_ids)
